...
.v-timer__code {
  ...
  border: 1px dashed rgba(124, 45, 18, 0.4);
}
...
.v-timer__code-btn:hover {
  background: #fffbeb;
}

.v-timer__code-btn:focus-visible {
...
.v-timer--minimal .v-timer__code {
  background: #ffffff;
  border-color: #e5e7eb;
}

.v-timer--minimal .v-timer__code-label {
  color: #6b7280;
}

.v-timer--minimal .v-timer__code-btn {
  color: #111827;
}
...
.v-timer--urgent .v-timer__code {
  background: rgba(255, 255, 255, 0.7);
  border-color: rgba(185, 28, 28, 0.45);
}

.v-timer--urgent .v-timer__code-label {
  color: #b91c1c;
}

.v-timer--urgent .v-timer__code-btn {
  color: #7f1d1d;
}
